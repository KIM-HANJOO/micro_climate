...
def get_summer_winter() :
    summer = [22, 22.7, 23.2,24.4,26.1,27.4,28.4,27.8,28.3,27.3,27.1,26.5,25.4,24,22.2,20.8,19.8,19.3,19.3,19.6,20,20.3,20.7,20.9]
    ...
    return list(reversed(summer)), list(reversed(winter))
