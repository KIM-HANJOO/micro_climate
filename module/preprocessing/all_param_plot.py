...
quest = input('start with sample case?(y/n)')

if quest == y :
    sample_dir = os.path.join(serials_dir, os.listdir(serials_dir)[0])

    
    os.chdir(os.path.join(serials_dir, os.listdir(serials_dir)[0]))
    

    
os.chdir(merged_dir)
sample = read_excel(os.listdir(merged_dir)[0])
...
#    
#    null_perc = round(all_index / null_count * 100, 2)
