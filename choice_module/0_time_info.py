...
for every excl in 'rounded',

check amount of time information each has, 
and make a visualizable list of all datas


0. get only 2021
1. percentage / date (for whole year)
2. percentage / date (for each seasons)
3. visualizable plot
...
# make a dataframe that includes all date info



for num_excel, excel in enumerate(os.listdir(sample_round)) :
    if num_excel < 100 :
        os.chdir(sample_round)
        temp = read_excel(excel)

        print(num_excel, '____', excel)
